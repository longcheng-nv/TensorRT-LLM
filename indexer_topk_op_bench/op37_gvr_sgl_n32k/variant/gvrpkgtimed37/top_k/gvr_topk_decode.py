...
class GvrTopKKernel:
            ...
            if cutlass.const_expr(cluster_size > 1):
                ...
                if N > max_slice_len:
                    ...
                    self._run_phases(
                        ...
                        phase_ts_row=phase_ts_row,  # [ptime]
                    )
                else:
    ...
    def _run_phases(
        ...
        phase_ts_row=None,  # [ptime] int64[8] leader-stamped clock64 timestamps
    ):
        ...
        if v_hi <= cutlass.Float32(self.NEG_FLT_MAX) or v_lo >= v_hi:
            ...
            # [ptime] t4: threshold final; just before Phase 3
            if is_leader & (tidx == cutlass.Int32(0)):
            ...
            # [ptime] t5: after Phase 3 collect (band or base)
            if is_leader & (tidx == cutlass.Int32(0)):
