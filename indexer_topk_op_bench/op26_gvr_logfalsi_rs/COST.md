...
## 8 · 小 N R0 门 A/B 收口 — 042→039 迁移接力(2026-07-13)

### GPU 花费

| 内容 | GPU-h |
|---|---|
| 042 段:harness 过滤器验证 + 11/27 批(单卡 07:17-07:36Z) | ~0.5 |
| 039 段:16 批 8 卡接力(07:41-07:55Z,含 g5 半批作废重测) | ~1.9 |
| smoke + r0auto 三点路径验证(单卡) | ~0.2 |
| gate 582/582(3 卡 dtype 分片) | ~0.8 |
| **小计(小 N 门)** | **≈ 3.4** |
