...
for CELL in "$@"; do
  ...
  env -u GITHUB_TOKEN -u HF_TOKEN CUDA_VISIBLE_DEVICES=$GPU GVR_BSX_DENSE_BS=8 \
    ...
    python3 scripts/ab.py --cell $CELL --tag ${TAG}_${CELL} --bs 8,16,32,64,128,256,512,1024 \
