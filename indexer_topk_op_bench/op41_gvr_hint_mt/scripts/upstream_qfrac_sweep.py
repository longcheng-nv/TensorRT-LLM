...
DEV = "cuda"
GROUPS = [("v32", "64k"), ("pro", "256k"), ("flash", "256k"),
          ("v32", "128k"), ("pro", "512k")]
BS_LIST = [16, 64, 256]
# candidates per K (descending CCDF fracs); "default" = ctor None
CANDS = {
    2048: [("v3port", (0.88, 0.55)), ("wide", (0.9, 0.6))],
    1024: [("v3port", (0.70, 0.35)), ("m1lo", (0.70,))],
    512: [("v3port", (0.65, 0.25)), ("m1lo", (0.65,))],
}
