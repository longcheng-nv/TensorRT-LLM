#!/usr/bin/env python3
"""Splice [ptime] clock64 phase timestamps into gvrpkgtimed/top_k/gvr_topk_decode.py.
...
gvrpkgprod2 package is NOT touched.
...
F = Path(__file__).resolve().parent.parent / "gvrpkgtimed" / "top_k" / "gvr_topk_decode.py"
src = F.read_text()
if "[ptime]" in src:
