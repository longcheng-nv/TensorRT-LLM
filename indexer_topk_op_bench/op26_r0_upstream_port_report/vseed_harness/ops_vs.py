...
"""vseed full-envelope regression sweep — 3 GVR arms.

  gvr_base : launch(..., enable_r0=False)   — secant baseline, PR launch shapes
  gvr_pr   : launch(...)                    — PR HEAD default (R0 M2D)
  gvr_vs   : launch(..., **VS_OVR)          — vseed candidate under test
...
def _vs_ovr(K):
    if K == 2048:
        return {"r0_vseed": True}
    return {"r0_vseed": True, "r0_qfracs": (0.85,)}


_OVR = {"gvr_base": {"enable_r0": False}, "gvr_pr": {}}
