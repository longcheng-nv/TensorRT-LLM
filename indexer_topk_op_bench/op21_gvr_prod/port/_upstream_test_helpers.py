...
"""Upstream test helpers, extracted VERBATIM from origin/main
tests/unittest/_torch/attention/sparse/test_cute_dsl_gvr_topk_decode.py
so the op21 port can re-run the upstream adversarial grid without a
tensorrt_llm install. Do not edit the two functions."""
import torch
