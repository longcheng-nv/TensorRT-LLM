...
Writes results/phase_v1g_40.json + prints the table.
"""
import csv
import json
import statistics
...
from gvrpkg40v1g.top_k.gvr_topk_decode import GvrTopKKernel as TimedK  # noqa: E402
...
def main():
    ...
    (OP40 / "results" / "phase_v1g_40.json").write_text(
        json.dumps(results, indent=1))
    print("\nwritten results/phase_v1g_40.json")
