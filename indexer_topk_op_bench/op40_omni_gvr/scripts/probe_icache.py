...
"""icache probe: unroll-reduction variants (adapted from csopt) (rung 2): on large-N real cells, time arm v5best at
...
CELLS = [("flash", "4k", 2), ("flash", "64k", 2), ("flash", "512k", 2),
         ("pro", "8k", 30), ("pro", "64k", 30), ("pro", "128k", 30),
         ("pro", "1024k", 30), ("v32", "8k", 34), ("v32", "32k", 34),
         ("v32", "128k", 34)]
CSS = ['v7', 'v9a', 'v9b', 'v9c']
