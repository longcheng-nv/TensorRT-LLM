...
class GvrTopKLBKernel:
    ...
    def __init__(
        ...
        # op#26 R0 histogram-ladder admission (forwarded to both underlying
        # GvrTopKKernel instances so the LB long-branch (cs) and short-branch
        # (cs=1) share the same run_one_row R0 fast path). Default OFF ->
        # byte-identical to the base LB kernel.
